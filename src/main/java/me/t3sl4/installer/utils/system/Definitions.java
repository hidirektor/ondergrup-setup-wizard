...
public class Definitions {
    public static final String CURRENT_VERSION = "v1.1.3";
    ...
    public static final String PREF_LAUNCHER_KEY = "updater_version";
    public static final String PREF_HYDRAULIC_KEY = "updater_version";
